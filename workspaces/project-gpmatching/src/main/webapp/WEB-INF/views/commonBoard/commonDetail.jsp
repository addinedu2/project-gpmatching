							...
							<table style="margin: 0 auto">
								<tr>
									<td style="width: 750px">
										<div class="col-md-8 col-xxl-9  mt-0 mt-md-3" style="width: 100%; resize: none;">
											<textarea class="form-control" aria-describedby="name" id="commentContent" name="commentContent" style="width: 100%; resize: none;"></textarea>
										</div>
									</td>
															...
															<c:choose>
																...
																<c:otherwise>
																	...
																	<div class="dropdown dropstart " style="float: right; align: middle">
																		<a class="text-muted text-primary-hover" href="#" role="button" id="dropdownTeam${ comment.commentNo }"
