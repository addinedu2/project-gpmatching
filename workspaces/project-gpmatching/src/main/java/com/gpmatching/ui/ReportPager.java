...
public class ReportPager {
	...
	public ReportPager(int dataCount, int pageNo, 
	...
	public String toString(){
		...
		if (pageNo > 1) {
			linkString.append(
				String.format("<li class='page-item'> "
						+ "      <a class='page-link' href='reportList?pageNo=1' aria-label='Previous'> "
						+ "        <span aria-hidden='true'><i class='mdi mdi-chevron-double-left'></i></span> "
						+ "      </a> "
						+ "     </li>"));
			linkString.append(
				String.format("<li class='page-item'> "
					+ "          <a class='page-link' href='reportList?pageNo=%d' aria-label='Previous'> "
		...
		for (int i = start; i < end; i++) {
			...
			if(i == pageNo) {
				linkString.append(String.format("<li class='page-item active' aria-current='page'> "
						+ "                        <a class='page-link' href='reportList?pageNo=%d'> "
						+ "						     <span class='sr-only'> %d </span> "
						+ "						   </a> "
						+ "                      </li>", i, i));
			} else { 
				linkString.append(String.format(
					"<li class='page-item'><a class='page-link' href='reportList?pageNo=%d'>%d</a></li>", i, i));
			}
		}
		...
		if (pageNo < pageCount) {
			linkString.append(String.format("<li class='page-item'> "
				+ "                            <a class='page-link' href='reportList?pageNo=%d' aria-label='Next'> "
